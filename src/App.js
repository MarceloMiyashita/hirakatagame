...
import Kanji from './syllabary/Kanji.js'
...
export default class App extends Component {
  state = {
    ...
    alertType: 'success',
    gameStart: false,
    characters: Object.assign(Hiragana, Katakana,Kanji),
    currentCharacter: ''
  }
  ...
  checkAnswer = answer => {
    if (answer == this.state.characters[this.state.currentCharacter]) {
      ...
      this.setState({
        ...
        alertText: `${this.state.currentCharacter} é escrito assim: "${
    ...
    return (
      <div>
        {!this.state.gameStart ? (
          <Fragment>
            <Title>Vamos aprender hiragana-katakana-Kanji</Title>
          ...
          <Fragment>
            ...
            <Title>Descubra o caracter</Title>
